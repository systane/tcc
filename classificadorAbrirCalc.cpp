...
int main (int argc, char* arg[]){
	...
	string outputFile = "classificacoes/distancia_euclidiana/Abrir_calc"
	// COLOCAR NA SAÍDA DO ARQUIVO O NOME DO TESTE - QUEBRAR A URL
	ifstream outFile(outputFile);
	if(outFile.is_open()){
		 outFile << "nomeTeste:" << exp(-distance) <<< endl;
	}
