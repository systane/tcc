...
\begin{singlespace}
	Dordan, M, K.Marcel Kfouri Dordan. Verifica{\c c}\~{a}o de Locutores dependen do discurso baseada na Evolu{\c c}\~{a}o do Esfor{\c c} Voc\'{a}lico.. IBILCE, UNESP, S\~{a}o Jos\'{e} do Rio Preto (Trabalho de Conclus\~{a}o de Gradua{\c c}\~{a}o em Ci\~{e}ncia da Computa{\c c}\~{a}o), 2015.
\end{singlespace}
...
\bibitem{Algoritmo_Reconhecimento_Padroes}
\begin{singlespace}
	CAOBIANCO, A. P. Compara{\c c}\~{a}o de Abordagens \textit{PatternMatching} e \textit{Knowledge-Based} para Reconhecimento de Locutor Dependente de Texto. IBILCE, UNESP, S\~{a}o Jos\'{e} do Rio Preto (Trabalho de Conclus\~{a}o de Gradua{\c c}\~{a}o em Ci\~{e}ncia da Computa{\c c}\~{a}o), 2011.
\end{singlespace}
